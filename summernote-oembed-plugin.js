(function (factory) {
    ...
    var embedToSummernote = function (context) {
        ...
        context.memo('button.oembed', function () {
            var button = ui.button({
                contents: '<i class="fa fa-window-maximize">',
    ...
    $.extend(true, $.summernote, {
        lang: {
            ...
            'pl-PL': {
                oEmbedButton: {
                    tooltip: "Osadź obiekt multimediów"
                },
                oEmbedDialog: {
                    title: "Osadzenie multimediów",
                    label: "Umieść poniżej link do osadzenia",
                    placeholder: "Np.: https://www.youtube.com/watch?v=sJ9HR-kcZHg",
                    button: "Wstaw"
                },
                errorMessage: {
                    invalid_provider: 'Linku nie można osadzić!'
                }
            },
            'pt-BR': {
                oEmbedButton: {
